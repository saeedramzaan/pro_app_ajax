...
<div class="container">
        <h2 class="text-center mt-5 mb-3">Project Manager App</h2>
        <div class="card">
    ...
    <form id="uploadForm" action = "check.php" method = "POST" enctype = "multipart/form-data">
         ...
         //  console.log(id+'text');
            ...
            $.ajax({
                ...
                success: function(info) {
                    ...
                    $("#name-info").html(info.name);
                    $("#description-info").html(info.email);
